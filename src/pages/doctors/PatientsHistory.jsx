        ...
        <div className="m-3 p-2">
          ...
          <div className="w-full">
            <div className="flex items-end justify-end">
              <h1 className="text-xs">search record by date...</h1>
            </div>
          </div>
              ...
              <div className="collapse-content">
                <div className="overflow-x-auto">
                  ...
                  <p className="text-sm">
                    ...
                    Nobis minus vitae cumque numquam placeat blanditiis in, cum
                    corrupti debitis aspernatur perspiciatis expedita animi sint
                    consequuntur dolores accusamus eveniet, voluptatibus
                    repellat commodi est eius nemo! Aliquam atque esse illo
                    maiores quidem sint, cupiditate ducimus ratione quisquam!
                    Esse mollitia velit possimus architecto consectetur quaerat
                    temporibus dolorem, reiciendis ipsa minima? Vel impedit
                    consequatur sed recusandae nisi soluta voluptatem explicabo
                    temporibus alias exercitationem libero nulla laboriosam
                    molestias est, optio quam. Cumque a minima dolorum.
                  </p>
